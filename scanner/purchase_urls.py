...
from scanner.purchase_views import purchase_remains_issue, purchase_general_issue, purchase_issue_log, purchase_spec_list, purchase_spec_detail, purchase_import, purchase_change_status, purchase_remains, purchase_issue, purchase_issue_remains, purchase_bulk_issue, purchase_reprint_nakladnaya, purchase_export_request, purchase_requests, purchase_create_request, purchase_request_detail, purchase_request_print, purchase_invoice_print
