...
from scanner.purchase_views import purchase_spec_list, purchase_spec_detail, purchase_import, purchase_change_status, purchase_remains, purchase_issue, purchase_bulk_issue, purchase_reprint_nakladnaya, purchase_export_request
